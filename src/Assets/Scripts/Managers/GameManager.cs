...
public class GameManager : MonoBehaviour {
    ...
    public Transform spawnPointWalker;
    public Transform spawnPointFlyer;
    ...
    IEnumerator rounds()
    {
        while (!_gameOver)
        {
            ...
            for (int i = 0; i < actualEnemies; ++i)
            {
                ...
                if(enemy.GetComponent<Enemy>()._type2 == 0)//Walker
                    GameObject.Instantiate(enemy, spawnPointWalker.position, spawnPointWalker.rotation);
                else//Flyer
                    GameObject.Instantiate(enemy, spawnPointFlyer.position, spawnPointFlyer.rotation);
                // Esperar
            ...
            if (boss!=null)
                GameObject.Instantiate(boss, spawnPointWalker.position, spawnPointWalker.rotation);
